...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Frequently Asked Questions | articlos',
    description: 'Everything you need to know about articlos — how it works, integrations, pricing, and content generation.',
    url: 'https://articlos.com/faq',
  },
  twitter: {
    card: 'summary',
    title: 'FAQ | articlos',
    description: 'Everything you need to know about articlos — pricing, integrations, and how AI content generation works.',
  },
}
